...
log_file = log_dir / \
    f"pipeline_run_{datetime.now().strftime('%Y-%m-%d_%H-%M')}.log"
logging.basicConfig(
    level=logging.INFO,
...
# Test symboly
TEST_SYMBOLS = ["AAPL", "MSFT", "GOOGL", "AMZN", "AMD", "NFLX", "INTC", "PLTR", "SNOW", "DIS", "BMY",
                "CRM", "O"]
...
if __name__ == "__main__":
    ...
    logger.info(
        f"Mode: {'FULL REFRESH' if args.full_refresh else 'INCREMENTAL'}")
